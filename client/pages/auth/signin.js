    ...
    <div className="w-full min-h-screen flex justify-center items-center">
      <div className="w-full max-w-sm mx-auto overflow-hidden rounded-lg shadow-md bg-gray-800">
        <div className="px-6 py-4">
          <h3 className="mt-3 text-xl font-medium text-cente text-gray-200">Welcome back</h3>

          <p className="mt-1 text-center text-gray-400">Sign In</p>
        ...
        <div className="flex items-center justify-center py-4 text-center bg-gray-700">
            ...
            <Link href="/auth/signup" className="mx-2 text-sm font-bold text-blue-400 hover:underline">Sign Up</Link>
        </div>
      </div>
    </div>
